...
"./SokobanApp":()=>{
      ...
      return __federation_import('/mfe/sokoban/assets/__federation_expose_SokobanApp-B8eFjAbP.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
