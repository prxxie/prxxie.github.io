const currentImports = {};
      ...
      let moduleMap = {
"./PostsApp":()=>{
      dynamicLoadingCss([], false, './PostsApp');
      return __federation_import('${__federation_expose_./PostsApp}').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
