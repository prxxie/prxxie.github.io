...
function getEyeOffset(direction: PetDirection): { ex: number; ey: number } {
  // Eye positions shift slightly based on direction + frame
...
export default function PetSprite({
  ...
  // Leg positions alternate for walking animation
  ...
  return (
    ...
    >
      ...
      {!isSleeping ? (
        ...
        <>
          {/* Sleeping eyes (closed — horizontal lines) */}
