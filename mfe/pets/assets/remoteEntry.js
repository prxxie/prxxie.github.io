const currentImports = {};
      ...
      let moduleMap = {
"./PetsApp":()=>{
      dynamicLoadingCss([], false, './PetsApp');
      return __federation_import('${__federation_expose_./PetsApp}').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
