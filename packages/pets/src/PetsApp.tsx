...
export default function PetsApp({
  ...
  return (
    <div className="flex flex-col items-center justify-between h-full py-4 px-2 text-ink font-body">
      {/* Header */}
      <div className="w-full border-b border-hairline pb-2 mb-4 text-center">
        <h2 className="font-display text-xs text-ink">PET STATUS CONSOLE</h2>
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full items-center justify-center flex-1">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="p-4 border border-hairline bg-surface-card rounded-lg flex items-center justify-center w-40 h-40 relative overflow-hidden">
            <span className="absolute top-1 left-2 text-[10px] text-ink font-mono select-none">+</span>
            <span className="absolute top-1 right-2 text-[10px] text-ink font-mono select-none">+</span>
            <span className="absolute bottom-1 left-2 text-[10px] text-ink font-mono select-none">+</span>
            <span className="absolute bottom-1 right-2 text-[10px] text-ink font-mono select-none">+</span>
          ...
          <div className="text-center">
            <span className="font-display text-[9px] block text-accent-amber">
              {getStageName(petState.stage)}
            </span>
            <span className="text-[8px] max-w-[160px] block mt-1 leading-normal text-ink opacity-85 italic">
        ...
        <div className="flex-1 flex flex-col gap-4 max-w-xs w-full">
          <div className="flex flex-col gap-2 text-[10px]">
            ...
            <div className="border border-hairline h-2.5 bg-surface-card p-0.5">
              <div
                className="bg-accent-amber h-full transition-all duration-500"
                style={{ width: `${xpProgress}%` }}
              />
            </div>
            <div className="text-[8px] text-ink opacity-60 text-right">
              {petState.stage < 5
            ...
            <div className="flex justify-between items-center mt-1">
              <span>STATUS:</span>
              <span className={isHungry ? "text-warning" : "text-success"}>
          ...
          {/* Action Buttons */}
          <div className="border-t border-dashed border-hairline pt-4 flex flex-col gap-2">
            <div className="flex justify-between text-[9px] mb-1">
              <span>AVAILABLE FOOD:</span>
              <span className="text-accent-amber">★ x {foodAvailable}</span>
            </div>
