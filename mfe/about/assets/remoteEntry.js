const currentImports = {};
      ...
      let moduleMap = {
"./AboutApp":()=>{
      dynamicLoadingCss([], false, './AboutApp');
      return __federation_import('${__federation_expose_./AboutApp}').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
