...
function PetsApp({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between h-full py-4 px-2 text-ink font-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full border-b border-hairline pb-2 mb-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xs text-ink", children: "PET STATUS CONSOLE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-accent-amber mt-1", children: hasProgress ? "SYSTEM SYNC: ACTIVE" : "STANDALONE MODE" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-6 w-full items-center justify-center flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-hairline bg-surface-card rounded-lg flex items-center justify-center w-40 h-40 relative overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 left-2 text-[10px] text-ink font-mono select-none", children: "+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-2 text-[10px] text-ink font-mono select-none", children: "+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-1 left-2 text-[10px] text-ink font-mono select-none", children: "+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-1 right-2 text-[10px] text-ink font-mono select-none", children: "+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            PetSprite,
            {
              size: 120,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-[9px] block text-accent-amber", children: getStageName(petState.stage) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[8px] max-w-[160px] block mt-1 leading-normal text-ink opacity-85 italic", children: [
            "“",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-4 max-w-xs w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 text-[10px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-hairline h-2.5 bg-surface-card p-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "bg-accent-amber h-full transition-all duration-500",
              style: { width: `${xpProgress}%` }
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-ink opacity-60 text-right", children: petState.stage < 5 ? `→ STAGE ${petState.stage + 1} at ${nextStageXp} XP` : "MAX EVOLUTION REACHED ★" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mt-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: isHungry ? "text-warning" : "text-success", children: isHungry ? "HUNGRY 🍽" : "CONTENT ✓" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-dashed border-hairline pt-4 flex flex-col gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: "btn btn-primary btn-sm h-10 px-5 w-full flex items-center justify-center gap-1 disabled:opacity-40 disabled:pointer-events-none",
              children: [
