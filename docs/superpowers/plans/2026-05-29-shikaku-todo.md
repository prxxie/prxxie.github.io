# Shikaku Implementation Todo List

- [x] Task 1: Scaffold MFE Package & Shell Integration
- [x] Task 2: Validation Engine
- [x] Task 3: Backtracking Solver
- [x] Task 4: State Management Store (Zustand)
